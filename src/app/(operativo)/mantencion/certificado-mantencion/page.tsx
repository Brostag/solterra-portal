    ...
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <header className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[#253158]">Certificados de Mantención</h1>
            <p className="mt-0.5 text-sm text-gray-500">
              Acreditan que el equipo quedó en condiciones operativas
            </p>
          </div>
        </div>
        {puedeCrear && (
          <Link
            href="/mantencion/certificado-mantencion/nuevo"
